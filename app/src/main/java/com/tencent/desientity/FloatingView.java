...
public class FloatingView extends Service implements View.OnClickListener {
    ...
    public static void ShowFloat(Context context){
        if (Instance == null)
        {
            Intent intent = new Intent(context, FloatingView.class);
    ...
    void createOver(){
       ...
       TextView closeBtn=mFloatingView.findViewById(R.id.closeBtn);
        ...
        TextView playerBtn=mFloatingView.findViewById(R.id.playerBtn);
        TextView itemBtn=mFloatingView.findViewById(R.id.itemBtn);
        TextView vehicleBtn=mFloatingView.findViewById(R.id.vehicleBtn);
    ...
    void InitMain() {
        ...
        final Switch isVech = mFloatingView.findViewById(R.id.isVech);
        isVech.setChecked(getConfig((String) isVech.getText()));
        isVech.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                setValue(String.valueOf(isVech.getText()), isVech.isChecked());
            }
        });
